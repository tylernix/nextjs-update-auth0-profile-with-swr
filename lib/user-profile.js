...
export function useProfile({user} = {}) {
    ...
    const { data, error, mutate } = useSWR('/api/auth/me', fetcher, {refreshInterval: 1000}); // We need a relatively quick refreshInterval to make changing the pages seamless.
